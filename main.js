...
var positive = confirm("Do you know what you are doing here?")
	if (positive) {
		//yes
		var name = confirm("Are you ready to make your brain hurt?")

		if (positive) {
			var welcome = confirm("Are you sure you want to keep going?")

			if (positive) {
				var brainHurt = prompt("Do you come with experience or none at all?")
				
				if (brainHurt = "Experience") {
					alert("OOOOH your poor brain! Okay your first day is in 10 mins!")
					alert(" I'll send you the prework make sure its done before you get to class, it should take you about 7 hrs!")
					alert("Good luck!")
				} else if(brainHurt = "None at all") {
